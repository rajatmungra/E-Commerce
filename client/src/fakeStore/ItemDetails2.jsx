...
const ItemDetails2= ()=>{
    ...
    return(
        ...
        <Box className={classes.leftContainer}>
             <img src={myObj.url} className={classes.productImage} alt='Error'/>
              <br/>
     ...
     <Box className={classes.rightContainer}>
             <Typography style={{borderBottom:'1px solid rgb(212, 212, 212)',fontWeight:700,fontSize:20}}>{myObj.title.mainTitle}</Typography>
             <Box>
                 <Typography style={{fontWeight:600, fontSize:25, display:'flex' , marginTop:50}}>
                     Price :  ₹  {myObj.price.cost} 
                 </Typography>
